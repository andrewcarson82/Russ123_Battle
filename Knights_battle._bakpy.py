...
current_fighter = 1
total_fighters = 6  # 2 knights + 2 bandits
action_cooldown = 0
action_wait_time = 90
attack = False
#potion = False
...
def draw_panel():
	...
	#show knight stats
#	draw_text(f'{knight1.name} HP: {knight1.hp}', font, RED, 100, screen_height - bottom_panel + 10)
	for count, i in enumerate(knight_list):
		#show name and health
		draw_text(f'{i.name} HP: {i.hp}', font, RED, 100, (screen_height - bottom_panel + 10) + count * 60)
...
###self, x, y, name, max_hp, attackval, defpoint, exp
#######            X     Y    NAME     HP   ATTACK
knight1 = Fighter(100, 260, 'Knight', 100, (random.randint(5,20)), 20, 20)
knight2 = Fighter(250, 260, 'Knight', 100, 20, 20, 20)
knight3 = Fighter(400, 260, 'Knight', 100, 20, 20, 20)
bandit1 = Fighter(550, 270, 'Bandit', 100, 6, 20, 20)
bandit2 = Fighter(700, 270, 'Bandit', 100, 6, 20, 20)
bandit3 = Fighter(850, 270, 'Bandit', 100, 6, 20, 20)
...
knight2_health_bar = HealthBar(100, screen_height - bottom_panel + 100, knight2.hp, knight2.max_hp)
knight3_health_bar = HealthBar(100, screen_height - bottom_panel + 100, knight3.hp, knight3.max_hp)

bandit1_health_bar = HealthBar(550, screen_height - bottom_panel + 40, bandit1.hp, bandit1.max_hp)
bandit2_health_bar = HealthBar(550, screen_height - bottom_panel + 100, bandit2.hp, bandit2.max_hp)
bandit3_health_bar = HealthBar(550, screen_height - bottom_panel + 100, bandit2.hp, bandit3.max_hp)
...
#	draw_text(str(knight.potions), font, RED, 150, screen_height - bottom_panel + 70)
	...
	if game_over == 0:
				...
				if current_knight_index < len(knight_list) and knight_list[current_knight_index].alive:
					...
					if action_cooldown >= action_wait_time:
						...
						if attack == True and target != None:
							...
							current_fighter += 1
							action_cooldown = 0
						# Remove the else clause - don't auto-advance knight turns
				else:
		...
		#enemy action (Bandit turns 3 and 4)
		if current_fighter == 3:  # First bandit
		...
		elif current_fighter == 4:  # Second bandit
	...
	if game_over != 0:
		...
		if restart_button.draw():
			...
			for bandit in bandit_list:
				bandit.reset()
			current_fighter = 1
			action_cooldown = 0  # Fixed: was missing = 0
			game_over = 0
